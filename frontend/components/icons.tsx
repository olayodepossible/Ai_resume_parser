/**
 * Inline 24x24 stroke icons, sized by the `size` prop and coloured by
 * `currentColor`. Local rather than an icon package: the set is small and it
 * keeps the dependency list to React and Next.
 */
...
export function LogoMark({ size = 28, className }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M10 9.5h7.5a4.5 4.5 0 0 1 0 9H13m-3 4v-13m0 13h4m6.5-4 3.5 4"
        stroke="var(--brand-on)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
